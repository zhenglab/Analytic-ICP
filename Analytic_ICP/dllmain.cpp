...
inline double feature_nonrigid_regist2d(double(*point_set4regist)[2], int num4regist
	, double(*aim_point_set)[2], int aim_num, int iterCount)
{
	...
	double result = Analytic_ICP_2D(ps4regist, num4regist
		, ps, aim_num, iterCount, 0.0000001);
...
DLL_ANALYTICICP double feature_transf2d(double(*point_set4regist)[2], int num4regist
	, double(*aim_point_set)[2], int aim_num, int iterCount)
{
	return feature_nonrigid_regist2d(point_set4regist, num4regist
...
DLL_ANALYTICICP void randomly_2d_map(double(*taget)[2], double(*moved)[2]
	, int num, int deg)
{
	AnalyticT2d(taget, moved, num, deg);
}
