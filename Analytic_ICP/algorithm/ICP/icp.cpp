...
Icp::Icp(Vector2d *&ps, int &p_num, int iterCount) :
...
Icp::Icp(Vector3d *&ps, int &p_num, int iterCount) :
...
void Icp::pointset2T(double *T, Vector2d *ps, const int p_num)
{
...
void Icp::pointset3T(double *T, Vector3d *ps, const int p_num)
{
	for (int i = 0; i != p_num; ++i)
	{
		T[i * 3] = ps[i](0);
...
void Icp::fit(Vector2d *&ps, int &p_num, MatrixXd &R, VectorXd &t, vector<int> &fit_set, const double indist)
{
...
void Icp::fit(Vector3d *&ps, int &p_num, MatrixXd &R, VectorXd &t, vector<int> &fit_set, const double indist)
{
...
void Icp::fit(double *T, const int T_num, MatrixXd &R, VectorXd &t, vector<int> &fit_set, const double indist) {
...
void Icp::fitIterate(double *&T, const int &T_num, MatrixXd &R, VectorXd &t, const vector<int> active, vector<int> &fit_set)
{
